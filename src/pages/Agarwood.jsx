                    ...
                    <div className="flex flex-col md:flex-row gap-12 items-center relative z-10">
                        <div className="flex-1">
                            ...
                            <div className="pt-6 border-t border-white/10 flex flex-wrap gap-4">
                                <a href="/Agar Oil/Agarwood TROPICAL EXTRACT Analyses Lexva_redated.pdf" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-brand-clay text-white px-5 py-3 rounded-xl hover:bg-[#a64526] transition-all shadow-lg focus:outline-none focus:ring-2 focus:ring-brand-clay focus:ring-offset-2 focus:ring-offset-[#1A1A1A]">
                                    <FileText size={18} />
